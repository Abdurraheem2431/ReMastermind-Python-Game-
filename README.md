This is a Python remake of the classic Mastermind code-breaking game built with Pygame. 
Players try to guess a hidden colour code within a limited number of attempts, using visual 
feedback to refine their guesses. The game includes multiple difficulty options, sound 
effects, power-ups, and a persistent leaderboard that saves and displays high scores.

INSTRUCTIONS TO RUN THE GAME

1. Download the ReMastermind Package.zip file, and unzip the folder.
...
d. Ensure that the folder in which the game data is stored can be accessed by 
   the IDE.
